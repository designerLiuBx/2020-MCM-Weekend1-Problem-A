...
struct _m_usmart_nametab usmart_nametab[]=
{
	...
	(void*)pwm_out1,"void pwm_out1(u16 pwm,u16 pwm2)",
	(void*)Set_angle,"void Set_angle(double angleTestp1, double angleTestr1)",
  (void*)Motor_pitch,"void Motor_pitch(double tarPitch)",
	(void*)Set_pidPar_pitch_v,"void Set_pidPar_pitch_v(double kp, double ti, double td , double limitingMax, double limitingMin)",
	(void*)mode,"void mode(int x)",
